...
public class Gynecology_obstetrics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gynecology_obstetrics);

        recyclerView = findViewById(R.id.recyclerView);

        db = FirebaseFirestore.getInstance();
        ref = db.collection("Gynecology and Obstetrics");
